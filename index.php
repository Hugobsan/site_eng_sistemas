...
<html lang="pt-br">
  ...
  <body>
    <div class="container-fluid d-flex justify-content-center my-auto">
        <div class="tela-de-login col-lg-4 col-md-6 col-sm-12">        
            <form>
                <div class="form-group">
                    <label for="exampleInputEmail1"><b>Login</b></label>
                    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Seu login">
                </div>
                <div class="form-group">
                ...
                <small class="botao-cadastro"><a href="#">Cadastre-se</a></small>
            </form>           
        </div>
    </div>
